...
// ВАЖНО: импортируем экшены прямо сюда, так как формы находятся здесь
...
// Это просто JSX-представление карточки, без логики D&D
export function TaskCardItem({ task, statuses }: TaskCardItemProps) {
  return (
    <div className="bg-white p-3 rounded-md shadow touch-none">
